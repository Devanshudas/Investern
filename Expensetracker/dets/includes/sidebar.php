...
?>
  ...
  <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-3">
                <em class="fa fa-navicon">&nbsp;</em>Investments <span data-toggle="collapse" href="#sub-item-3" class="icon pull-right"><em class="fa fa-plus"></em></span>
                </a>
                <ul class="children collapse" id="sub-item-3">
                    <li><a class="" href="stocks-dash.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> Stocks
                    </a></li>
                    <li><a class="" href="mutual-funds-dash.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> Mutual Funds
                    </a></li>
            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-4">
                <em class="fa fa-navicon">&nbsp;</em>Income <span data-toggle="collapse" href="#sub-item-4" class="icon pull-right"><em class="fa fa-plus"></em></span>
                </a>
