...
if(isset($_POST['submit']))
  {
    ...
    $dateincome=$_POST['dateincome'];
     $type=$_POST['type'];
     $valueincome=$_POST['valueincome'];
    $query=mysqli_query($con, "insert into tblincome(UserId,IncomeDate,IncomeType,IncomeValue) value('$userid','$dateincome','$type','$valueincome')");
if($query){
						...
						<div class="col-md-12">
							...
							<form role="form" method="post" action="">
								...
								<div class="form-group">
									...
									<input class="form-control" type="text" value="" required="true" name="valueincome">
								</div>
